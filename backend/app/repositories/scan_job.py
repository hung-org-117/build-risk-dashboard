...
class ScanJobRepository(BaseRepository):
    """Repository for scan job entities"""

    def __init__(self, db: Database):
        super().__init__(db, "scan_jobs")

    def create_job(self, repo_id: str | ObjectId) -> Dict[str, Any]:
    ...
    def get_active_job(self, repo_id: str | ObjectId) -> Optional[Dict[str, Any]]:
