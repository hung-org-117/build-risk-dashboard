        ...
        <div className="grid gap-4 md:grid-cols-4">
          <Card>
            <CardHeader className="pb-2">
              ...
              <CardTitle className="text-2xl">{poolStatus.total_tokens}</CardTitle>
            </CardHeader>
          </Card>
          <Card>
            <CardHeader className="pb-2">
              <CardDescription>Active</CardDescription>
              <CardTitle className="text-2xl text-green-600">{poolStatus.active_tokens}</CardTitle>
            </CardHeader>
          </Card>
          <Card>
            <CardHeader className="pb-2">
              <CardDescription>Rate Limited</CardDescription>
              <CardTitle className="text-2xl text-yellow-600">{poolStatus.rate_limited_tokens}</CardTitle>
            </CardHeader>
          </Card>
          <Card>
            <CardHeader className="pb-2">
              <CardDescription>Invalid</CardDescription>
              <CardTitle className="text-2xl text-red-600">{poolStatus.invalid_tokens}</CardTitle>
            </CardHeader>
          </Card>
        </div>
      )}
      ...
      {poolStatus && (
        <Card>
          <CardHeader className="pb-2">
            <div className="flex items-center justify-between">
              <div>
                <CardTitle className="text-base">Estimated Quota Available</CardTitle>
                <CardDescription>
                  ~{poolStatus.estimated_requests_available.toLocaleString()} requests remaining
                </CardDescription>
              </div>
        ...
        <Card className="border-red-500 bg-red-50 dark:bg-red-950">
          <CardHeader className="pb-2">
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-red-600 text-base">Pool Unhealthy</CardTitle>
            </div>
        ...
        <Card className="border-yellow-500 bg-yellow-50 dark:bg-yellow-950">
          <CardHeader className="pb-2">
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-yellow-600 text-base">Low Quota Warning</CardTitle>
            </div>
